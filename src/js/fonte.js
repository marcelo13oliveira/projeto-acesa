...
document.getElementById("aumentar-fonte").addEventListener("click", () => {
    document.querySelectorAll("h1, h2, h3, h4, h5, h6, p, form, button, span, a").forEach(function (el) {
...
document.getElementById("diminuir-fonte").addEventListener("click", () => {
    document.querySelectorAll("h1, h2, h3, h4, h5, h6, p, form, button, span, a").forEach((el) => {
